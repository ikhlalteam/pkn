...
<form method="post" action="index.php?m=content&p=auto">
	<div class="row">
		<div class="col-md-6">
			<div class="row">
				<div class="col-md-6"><input type="submit" class="btn btn-primary btn-block" name="b_GetAllUser_AllDevice" value="Get All User In All Device"></div>
				<div class="col-md-6"><input type="text" class="form-control" placeholder="Paging Limit" name="i_pagingGet" id="limit_paging_getuser"></div>
			</div>
		</div>
	</div>
	<br>
	<div class="row">
		<div class="col-md-6">
			<div class="row">
				<div class="col-md-6"><input type="submit" class="btn btn-primary btn-block" name="b_GetLogAllUser" value="Get All ScanLog In All Device"></div>
				<div class="col-md-6"><input type="text" class="form-control" placeholder="Paging Limit" name="i_pagingGetLog" id="limit_paging_getlog"></div>
				</ </div>
			</div>
			<br>
</form>
