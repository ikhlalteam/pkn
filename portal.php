...
<head>
  ...
  <link rel="stylesheet" href="vendor/dist/css/adminlte.min.css">
    <link href="vendor/css/frontend-style.css" rel="stylesheet">
  <link href="vendor/css/portal.css" rel="stylesheet">
</head>
...
<section class="content-section">
    <div class="container text-center">
      <div class="row">
        <div class="col-md-12">
          <div>
            <img src="images/logotutwurihandayani.png" alt="Tut Wuri Handayani Logo" style="width:120px;height:120px;">
          </div>
          <h2><i class="fa fa-home"></i> Selamat Datang</h2>
          <b><p class="lead mb-5">SISTEM PRESENSI SMK SUNAN DRAJAT</p></b>
        </div>
        <div class="col-md-4">
...
<!--             <i class="fa fa-users icon-menu"></i> -->
            <img src="images/admin.png" alt="admin Logo" style="width:100px;height:110px">
            <br>
            Login Admin
          </div>
        </a>
        ...
        <div class="col-md-4">
          <a href="loginpegawai.php">
          <div class="box">
<!--             <i class="fa fa-money icon-menu"></i> -->
            <img src="images/pegawai.png" alt="Pegawai Logo" style="width:100px;height:110px">
            <br>
            Login Pegawai
          </div>
        </a>
    ...
    <div class="text-center">
        ...
        <strong>Copyright &copy; <script>document.write(new Date().getFullYear())</script> PRESENSI SMK SUNAN DRAJAT</a></strong> 
    </div>
  </section>
