    ...
    <section class="content">
        <div class="row">
                        ...
                        <form id='formnya' onsubmit="return posting(event);">
                            <table class='table table-bordered'>
                                <tr>
                                    ...
                                    <td><input type='text' name='nama_role' id="nama_role" class='form-control' placeholder="Masukan Nama Role" required /></td>
                                </tr>
                                <tr>
          ...
          <span>&nbsp;&nbsp;</span>
            ...
            <input type='checkbox' name='select_role[]' class=\"row_role\" id='$id_halaman' value='$parent_halaman|$subparent_halaman|$dir_halaman|$urutan_halaman|$tampil_halaman|$icon_halaman' data-subparent='$subparent_halaman'>
            <span>&nbsp;&nbsp;</span>
            </label></li>";
                                        }
                                        echo "</ul></li>";
                        ...
                        <script>
                            function posting(e) {
                                ...
                                $.ajax({
                                    url: 'rolecontroller/tambahrolecontroller.php',
                                    type: "POST",
                                    processData: false,
                                    data: JSON.stringify({
                                        nama_role: nama_role,
